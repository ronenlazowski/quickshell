...
Rectangle {
    ...
    Column {
        ...
        Loader {
            ...
            visible: active
            active: Config.options.sidebar.quickSliders.showVolume && Audio.ready && !!Audio.sink?.audio
            sourceComponent: QuickSlider {
        ...
        Loader {
            ...
            visible: active
            active: Config.options.sidebar.quickSliders.showMic && Audio.ready && !!Audio.source?.audio
            sourceComponent: QuickSlider {
                materialSymbol: "mic"
                value: Audio.source?.audio?.volume ?? 0
                onMoved: {
                    if (Audio.ready && Audio.source?.audio) {
